...
-- Late is recorded separately from present because institutions report on it
-- separately, and — following the mockups — it does not count toward the
-- attendance percentage.
create type public.attendance_mark as enum ('present', 'absent', 'late');
